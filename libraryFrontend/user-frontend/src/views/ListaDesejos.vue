    ...
    <div class="container">
      ...
      <main>
        <div class="welcome-container">
          <h2 class="welcome-title">Lista de Desejos</h2>
          <p>Seja bem-vindo à sua Biblioteca, explore todos os livros desejados por você em um só lugar.</p>
          ...
          <div class="search-container2">
            <input
              type="text"
              class="search-bar2"
              placeholder="Pesquisar em lista de desejos..."
              v-model="searchQuery"
            />
        ...
        <div class="pagination">
          <button class="btn-navegacao" @click="previousPage" :disabled="paginaAtual === 1">Anterior</button>
          <span>Página {{ paginaAtual }} de {{ totalPages }}</span>
          <button class="btn-navegacao" @click="nextPage" :disabled="paginaAtual === totalPages">Próximo</button>
        </div>
      </main>
    </div>
    <Footer />
